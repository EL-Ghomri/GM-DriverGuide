...
function weatherReport(latitude, longitude) {
	...
	var apiKey       = '9eb83b4281bf516c2a04e28fb3d90c30',
	...
	$.getJSON(api_call, function(forecast) {
		...
		for(var i = 0, l = forecast.daily.data.length; i < l - 1; i++) {
			...
			$("#forecast").append(
				...
				"<li><div style='height: 300px;'><canvas class=" + skicons + " style='float:right;'></canvas>"+
				"<div id='date'><font size='3'>" + date.toLocaleDateString()+"</font></div>"+
				"<br/><div id='temp'>" + temp  +"°</div>"+
				"<br/><p>" + summary + "</p>" +
				"<div class='moreInfo'>Max Temp : " + tempMax + 
				"</br>Humidity : " + humidity +
				"</br><div class='back card'>" +
				"<div class='hourly" + " " + day + "'>24hr Forecast : <ul class='list-reset'></ul></div></div>"+
